...
export async function enviarEmail(Data: any): Promise<string> {
    try {
      ...
      let datos_qr:any = {
        ...
        noAsiento: Datos.No_Asiento,
        origen: Datos.Origen_Viaje,
        destino: Datos.Destino_Viaje,
        noServicio: Datos.No_Servicio,
        fechaSalida: Datos.Fecha_Hora_Salida,
        horaSalida: Datos.Fecha_Hora_Salida,
        puertaEnbarque: Datos.Puerta_Embarque,
        tokenFacturacion: Datos.Token_Facturacion,
        categoria: Datos.Categoria,
        noOperacion: Datos.No_Operacion,
        totalPago: Datos.Total_Pago,
      ...
      let url_imagen = await this.convertToImage(datos_qr);
